  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        ...
        const token = localStorage.getItem('token'); // Adjust storage as per your app
                ...
                >
                  ...
                  <td className="px-4 py-2 border">
                    <div className="flex space-x-2">
                      <button
                        className="text-teal-600 hover:underline"
                        onClick={() => console.log(`Viewing ${patient.username}`)}
                      >
                        <Eye className="h-5 w-5" />
                      </button>
                      <button
                        className="text-teal-600 hover:underline"
                        onClick={() => console.log(`Editing ${patient.username}`)}
                      >
                        <Edit className="h-5 w-5" />
                      </button>
                      <button
