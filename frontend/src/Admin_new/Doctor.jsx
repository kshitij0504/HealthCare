...
const Doctor = () => {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      // Fetch doctors for organization ID 1
  ...
  const handleView = (doctor) => {
    ...
    alert(`Viewing details for ${doctor.firstname} ${doctor.lastname}`);
  };
  ...
  if (loading) {
    return (
      <div className="flex">
        <Sidebar />
        <div className="ml-64 p-8 w-full bg-gray-50 min-h-screen flex items-center justify-center">
            ...
            <table className="min-w-full table-auto">
              <thead>
                <tr className="bg-teal-100">
                  ...
                  <th className="px-6 py-3 text-left text-gray-600 font-medium">Specialty</th>
                  <th className="px-6 py-3 text-left text-gray-600 font-medium">Hospital</th>
                  <th className="px-6 py-3 text-left text-gray-600 font-medium">Actions</th>
                </tr>
              </thead>
              <tbody>
                {doctors.map((doctor, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 border-b">{doctor.specialty}</td>
                    <td className="px-6 py-4 border-b">{doctor.organization?.name}</td>
                    <td className="px-6 py-4 border-b">
                      <div className="flex items-center space-x-4">
                        <button
                          className="text-teal-600 hover:text-teal-800"
